                                        ...
                                        <div class="table-responsive">
                                          <table class="table table-striped">
                                            ...
                                            <tr>
                                              ...
                                              <td>
                                                @if ($item->foto)
                                                <img class="mb-3" src="{{url('foto/'.$item->foto)}}" style="width: 50px;">
                                                @endif </td>
                                              <td>{{$item->nama}}</td>
                                              ...
                                              <td>
                                                <button class="icon-button-1">
                                                  <i class="fa fa-print" href="#" style="font-size:30px;"></i>
                                                </button>
                                                ...
                                                <form>
                                                    <button type="submit" class="icon-button-3"><i class="fa fa-trash-o"style="font-size:30px;"></i></button>
                                                </form>
                                                <!--  -->
                                              </td>
                                            </tr>
